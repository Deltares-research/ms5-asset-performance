...
if __name__ == "__main__":
    ...
    model_path = r"../results/srg/mlp/lr_1.0e-05_epochs_100000_fullprofile_True/torch_weights.pth"
    posterior_path = r"../../results/hmc/posterior_data.netcdf"
    scaler_x_path = r"../results/srg/mlp/lr_1.0e-05_epochs_100000_fullprofile_True/scaler_x.joblib"
    scaler_y_path = r"../results/srg/mlp/lr_1.0e-05_epochs_100000_fullprofile_True/scaler_y.joblib"
