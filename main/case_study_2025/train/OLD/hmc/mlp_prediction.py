...
from main.case_study_2025.fos_calculation.moment_calculation.mlp_moments import FoSCalculator
from main.case_study_2025.train.surrogate.utils import load_data


if __name__ == "__main__":

    model_path = r"../results/surrogate/mlp/lr_1.0e-05_epochs_100000_fullprofile_True/torch_weights.pth"
    posterior_path = r"../../results/hmc/posterior_data.netcdf"
    scaler_x_path = r"../results/surrogate/mlp/lr_1.0e-05_epochs_100000_fullprofile_True/scaler_x.joblib"
    scaler_y_path = r"../results/surrogate/mlp/lr_1.0e-05_epochs_100000_fullprofile_True/scaler_y.joblib"
    srg_data_path = r"../data/srg_data_20250604_100638.csv"

    _, y = load_data(srg_data_path, full_profile=True)
    n_points = y.shape[-1]
    ...
    posterior_displacements = fos_calculator.inference(X)

    moments = fos_calculator.moments(posterior_displacements)

    plot_path = Path("../../results/hmc/mlp")
